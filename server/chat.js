...
const defaultSuggestions = ['Подобрать услугу', 'Как подготовиться', 'Свободное время', 'Цены на услуги']
...
const answerSets = [
  {
    ...
    suggestions: ['Открыть услуги', 'Записать питомца', 'Сколько длится уход', 'Что входит в цену'],
  },
  {
    ...
    suggestions: ['Записать кота', 'Подготовка к визиту', 'Уход без купания', 'Как проходит визит'],
  },
  {
    ...
    suggestions: ['Записать на когти', 'Экспресс-уход', 'Спросить про щенка', 'Добавить к грумингу'],
  },
  {
    ...
    suggestions: ['Первый визит', 'Экспресс-уход', 'Записать питомца', 'Как снизить стресс'],
  },
  {
    ...
    suggestions: ['Перейти к записи', 'Выбрать услугу', 'Контакты салона', 'Свободное время'],
  },
  {
    ...
    suggestions: ['Записаться', 'Что взять с собой', 'Первый визит', 'Можно ли кормить'],
  },
]
